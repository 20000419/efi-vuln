  ...
  if ( v2 )
  {
    if ( (v4 & 0x20) == 0 )
    {
      ...
      if ( result >= 0 )
      {
        ...
        v40 = 0;
        v33 = 563i64;
        ((void (__fastcall *)(const __int16 *, EFI_GUID *, unsigned int *, __int64 *, _BYTE *))gRT->GetVariable)(
          L"IntelSetup",
          ...
          v44);
        v44[108] = 1;
        UINTN correctDataSize = 563; // Re-initialize DataSize with actual buffer size
