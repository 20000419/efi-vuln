__int64 __fastcall sub_BC8(EFI_CAPSULE_HEADER **a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, _QWORD, __int64 *, _BYTE *))gRT->GetVariable)(
      ...
      &v10,
      v7);
    v10 = 1943i64; // Reinitialize DataSize to buffer size
    ...
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, _QWORD, __int64 *, _BYTE *))gRT->GetVariable)(
      ...
      &v10,
      v6);
    v10 = 1057i64; // Reinitialize DataSize to buffer size
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, __int64, __int64, _BYTE *))gRT->SetVariable)(
      L"SaColdReset",
      &SA_SETUP_VARIABLE_GUID,
      2i64,
    ...
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, _QWORD, __int64 *, _BYTE *))gRT->GetVariable)(
      ...
      &v10,
      v4);
    v10 = 143i64; // Reinitialize DataSize to buffer size
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, __int64, __int64, _BYTE *))gRT->SetVariable)(
      L"MeColdReset",
      &ME_SETUP_VARIABLE_GUID,
      2i64,
    ...
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, _QWORD, __int64 *, _BYTE *))gRT->GetVariable)(
      ...
      &v10,
      v5);
    v10 = 678i64; // Reinitialize DataSize to buffer size
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, __int64, __int64, _BYTE *))gRT->SetVariable)(
      L"CpuColdReset",
      &CPU_SETUP_VARIABLE_GUID,
      2i64,
    ...
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, _QWORD, __int64 *, _BYTE *))gRT->GetVariable)(
      ...
      &v10,
      v8);
    v10 = 2083i64; // Reinitialize DataSize to buffer size
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, __int64, __int64, _BYTE *))gRT->SetVariable)(
      L"PchColdReset",
      &PCH_SETUP_VARIABLE_GUID,
      2i64,
    ...
    ((void (__fastcall *)(const __int16 *, EFI_GUID *, _QWORD, __int64 *, __int64 *))gRT->GetVariable)(
      ...
      &v10,
      &v9);
    v10 = 2i64; // Reinitialize DataSize to buffer size
