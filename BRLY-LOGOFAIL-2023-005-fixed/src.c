        ...
        __int64 a7)
{
  ...
  // Fixed OOB Read: Strengthened buffer boundary check
  if ( ((Total + v15) >> 3) + 4 <= ImageSize )
  {
    v21 = a6;
    v22 = qword_1D50;
    do
...
LABEL_44:
    ...
    // Fixed OOB Read: Ensure next iteration will not exceed buffer bounds
    while ( ((v16 + v15) >> 3) + 4 <= ImageSize );
  }
  return v16;
}
